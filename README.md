...
- **[팀프로젝트] TalkTrip** (2025.07-2025.08):  
  AI 서비스 및 실시간 채팅 기반 여행 상품 판매 플랫폼 개발 풀스택 프로젝트  
  **주요 기술**: JAVA, Springboot, Javascript, React, TailwindCSS, python, FastAPI, MySQL, MongoDB, Redis, Apache Kafka, Vecel, AWS EC2, AWS RDS, Langchain, NLP  
